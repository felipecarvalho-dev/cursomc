...
import com.felipesouto.cursomc.domain.Pagamento;
import com.felipesouto.cursomc.domain.PagamentoComBoleto;
import com.felipesouto.cursomc.domain.PagamentoComCartao;
...
import com.felipesouto.cursomc.repositories.CidadeRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException{
		...
		Categoria cat1 = new Categoria(null, "Informatica");
		 ...
		 Cliente cli1  = new Cliente(null, "Maria Silva", "filipisouto28@hotmail.com", "11430106638", TipoCliente.PESSOAFISICA,pe.encode("123")); 
		 Cliente cli2  = new Cliente(null, "Felipe Carvalho", "felipihsc@gmail.com", "11430104420", TipoCliente.PESSOAFISICA,pe.encode("123"));
		 cli2.getTelefones().addAll(Arrays.asList("96050222"));
		 cli2.addPerfil(Perfil.ADMIN);
		 
		 cli1.getTelefones().addAll(Arrays.asList("920000172","920000173"));
		 
		 Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto303", "Jardim", "38220834", cli1, c1);
		 Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38220823", cli1, c2);
		 Endereco e3 = new Endereco(null, "Rua Samuel Lessa", "300", "Casa", "Edgar Pereira", "38220834", cli2, c2);
		...
		Pagamento pagto3= new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped3, sdf.parse("28/10/2017 00:00") ,null);
		...
		ItemPedido ip4 = new ItemPedido(ped3, p2, 100.00, 1, 800.00);
